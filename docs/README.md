...
- **[Analytic Archive Spec](./specs/ui/analytic_archive.md)**: 記録画面の構成とレイアウト定義
- **[Sector Spec](./specs/systems/world/sector.md)**: セクター（ステージ）環境のクラス定義
...
- **[Achievement System](./specs/systems/achievements.md)**: 統計データと実績称号の定義
- **[Data Manager Spec](./specs/systems/data_manager.md)**: セーブデータ管理と永続化の定義
- **[Class Roles](./specs/systems/class_roles.md)**: 実装に必要なクラスの役割定義
- **[Item Class Spec](./specs/systems/entities/item.md)**: アイテム基底クラスのインターフェース定義
- **[StackedItem Spec](./specs/systems/entities/stacked_item.md)**: スタック可能なアイテムのインターフェース定義
