# Gravity Freight Development Documentation

Gravity Freight の設計・開発に関する全ドキュメントのインデックスです。
すべての開発作業は、[Core Philosophy](./CORE_PHILOSOPHY.md) に基づいて行われます。

## 核心ドキュメント
- **[Core Philosophy](./CORE_PHILOSOPHY.md)**: 開発の三大原則（共通化・階層化・意味論）
...
## 計画・進捗
- **[Development Backlog](./planning/backlog.md)**: 現在の開発バックログ
...
---
*Note: このドキュメント群は、Gravity Freightプロジェクトにおいて「唯一の真実」として機能します。*
